...
function affich_guide() {
    ...
    guide.innerHTML='                    <div class="bg-modal">\n' +
        ...
        '                            du module.\n' +
        '                            <br>\n' +
        '                            <img class="mt-5" src="'+DJANGO_STATIC_URL+'img/nav.JPG">\n' +
        '                        </div>\n' +
        ...
        '                            <br>\n' +
        '                            <br>\n' +
        '                            <img class="mt-2" src="'+DJANGO_STATIC_URL+'img/navhover.JPG">\n' +
        '                        </div>\n' +
        '                        <div id="guide4" class="guide-content">\n' +
        '                            <h3>III.Manipulation des structures:</h3>\n' +
        '\n' +
        '                            <img class=" d-inline" src="'+DJANGO_STATIC_URL+'img/sidebar.JPG" height="300">\n' +
        ...
        '                                <br>\n' +
        '                            </div>\n' +
        '                            <img class=" d-inline" src="'+DJANGO_STATIC_URL+'img/side.JPG" height="300" width="450">\n' +
        '\n' +
        '\n' +
        '                        </div>\n' +
        ...
        '\n' +
        '                            </div>\n' +
        '                            <img class=" d-inline" src="'+DJANGO_STATIC_URL+'img/init.JPG" height="300" width="400">\n' +
        '\n' +
        '\n' +
        '                        </div>\n' +
        ...
        '\n' +
        '                            </div>\n' +
        '                            <img class=" d-inline" src="'+DJANGO_STATIC_URL+'img/rech.JPG" height="300" width="400">\n' +
        '\n' +
        '\n' +
        '                        </div>\n' +
        ...
        '\n' +
        '                            </div>\n' +
        '                            <img class=" mt-3 d-inline" src="'+DJANGO_STATIC_URL+'img/vitesse.JPG" >\n' +
        '                        </div>\n' +
        ...
        '\n' +
        '                            </div>\n' +
        '                            <img class=" mt-5 d-inline" src="'+DJANGO_STATIC_URL+'img/pause.JPG" >\n' +
        '                        </div>\n' +
        '\n' +
...
function imgurl() {
    return ''+DJANGO_STATIC_URL+struct_name+'/img/struct.JPG'
}