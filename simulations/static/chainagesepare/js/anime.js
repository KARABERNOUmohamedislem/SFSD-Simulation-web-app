        ...
        for (let k = 0; k < colnumber; k++) {
            ...
            if (id != "liste") {
                if (k == 0) {
                    ...
                    img.className = "cover";
                    img.src = DJANGO_STATIC_URL+struct_name+"/img/images/vide.png";
...
async function Insertion_anime_secon(enreg, indice, emplacement) {
    ...
    img2.src =  DJANGO_STATIC_URL+struct_name+"/img/images/plein.png";
    ...
    img.src =  DJANGO_STATIC_URL+struct_name+"/img/images/link4.png";
    imgcase.append(img);
